...
app.title("Luas Dan Volume Prisma Segitiga")
...
# Alas Segitiga
label_alas = tk.Label(app, text="Alas Segitiga : ")
...
label_tinggi_prisma.grid(row=5, column=0, columnspan=2, padx=5, pady=5)
entry_tinggi_prisma = tk.Entry(app)
entry_tinggi_prisma.grid(row=5, column=2, columnspan=2, padx=5, pady=5)
